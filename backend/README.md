...
## Project Structure
    ...
    ├── new_regression_app__50836  # Django project configurations
...
1. Clone this repo and `cd new_regression_app__50836`
...
2. Clone this repo and `cd new_regression_app__50836`
